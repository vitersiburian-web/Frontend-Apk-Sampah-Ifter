<template>
  <q-page class="q-pa-md bg-green-1">
    ...
    <div class="row q-mb-md">
      <q-btn-toggle
        ...
        :options="[
          ...
          { label: 'Data User', value: 'user', to: { name: 'TambahUser' } }
        ]"
        unelevated
        spread
    ...
    <q-card flat class="form-card q-pa-md">
        <div class="text-subtitle1 text-grey-8 q-mb-lg text-weight-bold">Masukkan data petugas</div>
...
import { addPetugas } from 'stores/adminStore';
...
const submitForm = () => {
    ...
    $q.notify({ message: `Petugas ${form.value.name} berhasil ditambahkan.`, color: 'positive' });
